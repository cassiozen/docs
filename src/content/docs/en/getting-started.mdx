...
hero:
  ...
  facepile:
    tagline: Powered by Astro and ousssr open-source contributors.
    linkText: Join us!
    link: /en/contribute/
---
...
<CardGrid>
  ...
  <Card title="Take a guided tour" icon="star">
    Complete our introductory [Build a Blog Tutorial](/en/tutorial/0-introduction/) to learn the basics sssand create your first Astro site.
  </Card>
